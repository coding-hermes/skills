...
| [`coding-hermes-retrospective-selfimprovement`](coding-hermes-retrospective-selfimprovement/SKILL.md) | Improvement | 改善 Kaizen — facts-first goal → subgoals → execute → re-evaluate → quorum; never plan from memory |
