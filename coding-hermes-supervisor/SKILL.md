...
**Proven:** 2026-07-18 — helios (2400s, pri=6) and helios-work (2400s, pri=5) both pointed to ~/helios-work and were both enabled. helios-work disabled (lower priority). hivemind-pulse (pri=8) and hivemind-work (pri=5) both pointed to ~/hivemind-work and were both enabled. hivemind-pulse disabled (created later, same workdir).
...
**Proven:** 2026-07-19 — `heading` (P=5, created 2026-07-19T14:04) and `HEADING` (P=10, created 2026-07-18) both pointed to ~/heading. `heading` disabled (created later, lower priority).
